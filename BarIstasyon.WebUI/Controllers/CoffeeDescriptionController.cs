...
namespace BarIstasyon.WebApi.Controllers
{
    ...
    [ApiController]
    public class CoffeeDescriptionController : ControllerBase  // ControllerBase, API controller'ları için daha uygun bir sınıftır.
    {
        private readonly CreateCoffeeDescriptionCommandHandler _createCoffeeDescriptionCommandHandler;

        public CoffeeDescriptionController(CreateCoffeeDescriptionCommandHandler createCoffeeDescriptionCommandHandler)
        {
