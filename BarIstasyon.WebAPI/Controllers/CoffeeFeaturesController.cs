...
namespace BarIstasyon.WebApi.Controllers
{
    ...
    [ApiController]
    public class CoffeeFeaturesController : ControllerBase  // ControllerBase, API controller'ları için daha uygun bir sınıftır.
    {
        private readonly CreateCoffeeFeatureCommandHandler _createCoffeeFeatureCommandHandler;

        public CoffeeFeaturesController(CreateCoffeeFeatureCommandHandler createCoffeeFeatureCommandHandler)
        {
