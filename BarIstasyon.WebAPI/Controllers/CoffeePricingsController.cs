...
namespace BarIstasyon.WebApi.Controllers.CoffeePricingControllers
{
    ...
    [ApiController]
    public class CoffeePricingsController : ControllerBase  // ControllerBase, API controller'ları için daha uygun bir sınıftır.
    {
        private readonly CreateCoffeePricingCommandHandler _createCoffeePricingCommandHandler;

        public CoffeePricingsController(CreateCoffeePricingCommandHandler createCoffeePricingsCommandHandler)
        {
